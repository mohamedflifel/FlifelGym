 ...
 * @author PC
 */
public class AdherantTodayActivities extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(AdherantTodayActivities.class.getName());
    private final int adherantId;
    /**
     * Creates new form AdherantTodayActivities
     */
    public AdherantTodayActivities(int adherantId) {
        ...
        home.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                AdherantInf c =new AdherantInf(adherantId);
                c.setLocationRelativeTo(null);
                c.pack();
                c.setVisible(true);

                AdherantTodayActivities.this.dispose();
            }
            @Override
    ...
    public List<ActivityModel> loadActivities(){
        ...
        String query = "select * from activity where activity_date = CURDATE()";
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Activity Id", "Title", "Description", "Activity Date", "Start Time", "End Time", "Added By Admin ", "Coached by "
            }
        ) {
    ...
    //     java.awt.EventQueue.invokeLater(() -> new AdherantTodayActivities().setVisible(true));
    // }
